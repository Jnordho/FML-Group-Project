...
I am selecting the variables that have the least missing values and most relevance to the target response of city perception 
```{r}
set.seed(123)
library(tidyverse)
library(VIM)
...
```{r}
k3 <- kNN(normalized_data, variable = c("Happy", "Satisfied_Gen", "Satisfied_Live", 
